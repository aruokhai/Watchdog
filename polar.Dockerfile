...
######## Watchtower plugin Modifications
FROM rust:1.67 as watchtower
...
COPY --from=watchtower /usr/local/cargo/bin/watchtower-client /usr/local/bin/watchtower-client
...
COPY polar/docker-entrypoint.sh /entrypoint.sh
COPY polar/bashrc /home/clightning/.bashrc
...
EXPOSE 9735 9835 8080 10000 4400 80 8814 9814
